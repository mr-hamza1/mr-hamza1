...
I'm a passionate full-stack developer and CS student with **almost 2 years of experience** in building and deploying real-world web applications.  
I’ve completed **a full month of intensive tech development** focusing on scaling and improving app performance.  
My expertise lies in **[DSA]**, **[C++]**, and **modern web technologies**. Recently, I’ve been working extensively with the **[MERN stack](https://www.mongodb.com/mern-stack)** — **MongoDB, Express.js, React.js, and Node.js**.  

I also have experience with **Conicom**, which gave me additional exposure to real-world software development challenges.  
I love solving problems on [LeetCode](https://leetcode.com/u/Mr_Hamza/) and bringing ideas to life through code.

### 👨‍💻 Current Focus
- 🔧 Building real-world projects with the MERN stack.
- 🌐 Learning advanced backend development and real-time systems.
- 💬 Ask me about **C++**, **React**, or building full-stack web apps.
...
- 🏡 **[Airbnb Clone](https://github.com/mr-hamza1/listing)**  
  MERN-based rental booking web app with listing pages, user authentication, and booking features.

- 💬 **[Real-Time Chat App](https://github.com/mr-hamza1/chat-app-frontend)**  
  A socket.io powered full-stack chat application supporting real-time messaging.

- 🛒 **[E-commerce Website](https://github.com/mr-hamza1/e-commerce-frontend)**  
